...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		String guess = JOptionPane.showInputDialog("who is this? (just the first name)");
		...
		showNextImage();
		String guess2 = JOptionPane.showInputDialog("who is this? (just the first name)");
		...
		showNextImage();
		String guess3 = JOptionPane.showInputDialog("who is this? (just the first name)");
		...
		showNextImage();
		String guess4 = JOptionPane.showInputDialog("who is this? (just the first name)");
